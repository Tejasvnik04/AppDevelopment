...
function Dashboard() {
  ...
  const handleSubmit = async (event) => {
    ...
    const token="eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJrdmlAZ21haWwuY29tIiwiaWF0IjoxNjk3MTcyMjYwLCJleHAiOjE2OTcyNTg2NjB9.f4ZVvXvs4TpaVZrRcHiRdBvJFS6DrrxQ85GxsZvzZw8";
    try {
      console.log(token)
